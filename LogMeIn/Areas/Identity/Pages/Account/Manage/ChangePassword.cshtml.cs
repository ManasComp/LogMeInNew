...
public class ChangePasswordModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        _logger.LogInformation("Uživatel změnil úspěně svoje heslo");
    ...
    public class InputModel
    {
        ...
        /// </summary>
        [Required(ErrorMessage = "Tento atribut je povinný")]
        [StringLength(100, ErrorMessage = "{0} musí být dlouhé minimálně {2} znaků a maximálně {1} znaků.",
            MinimumLength = 6)]
        [DataType(DataType.Password)]
        ...
        [Compare("NewPassword", ErrorMessage = "Nové heslo se neshoduje s jeho potvrzením.")]
